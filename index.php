...
<body>
	...
	<section class="content">
		<div class="container">
			...
			<h2 class="text-center">In the meantime, if you’d like to get in touch<br> please submit an enquiry using the form below</h2>
		</div>
	</section>
			...
			<div class="enquiry-form">
				<form>
					...
					<div class="form-group">
						...
						<textarea name="txtAdditionalInfo" id="txtAdditionalInfo" class="form-control" placeholder="Additional Information"></textarea>
					</div>
					<div class="form-group">
